    ...
    <b-row>
      ...
      <b-row>
        <b-col class="text-center">
          <ta-table bordered hover :items="cart" :fields="fields">
             ...
             <template v-slot:cell(#)="data" >
              ...
              <template v-slot:cell(remove)="data" >
                <b-button @click="remove(data.item.id)" variant="danger" class="mr-2">
                 ...
                 <b-col class="text-center">
                   <b-img style="max-width: 5rem;" :src="require(`@/assets/img/fruits/fruit${data.item.id}.jpeg`)" fluid alt="Responsive image"></b-img>
                   </b-col>
                   </template>
                 ...
                 <b-row class="mt-4 text-center" v-if="cart.length > 0">
                   <b-col>
                    ...
                    <b-col></b-col>
                    <b-col cols="4">Difruta lo maximo en tu descuento virtual</b-col>
                    ...
                    <b-col>
                      <b-button @click="buy" variant="success" block class="mr-2">
                       ...
                       centered title="Purcharse Completed ">
